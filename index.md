...
<body>
            ...
            <div class="row no-padding ">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center">
                    <div class="products-chart" >
                        <img  src="images/overview.png" style="max-width:900px;width:100%;height:auto;padding-top:20px;">
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer class="footer">
            ...
            <div class="container">
                <div class="row">
                    <div class="footer-col col-md-4">
                        <h5>Location</h5>
                        <p>Schnewlinstr. 6<br>79199 Freiburg<br>Germany</p>
                    </div>
                    <div class="footer-col col-md-4">
                        <h5>Share with Love</h5>
                        <ul class="footer-share">
               
                            <li><a href="https://twitter.com/cedalo_com"><i class="fa fa-twitter"></i></a></li>
                            <li><a href="https://www.linkedin.com/company/cedalo-ag/"><i class="fa fa-linkedin"></i></a></li>
                        
                        </ul>
                    </div>
                    <div class="footer-col col-md-4">
                        <h5>About cedalo</h5>
                        <p>Cedalo is a german open-source company dedicated to make stream processing accessable for end-users</p>
                    </div>
                </div>
            </div>
        </div><!-- footer top -->
        <div class="footer-bottom">
            <div class="container">
                <div class="col-md-12">
                    <p>Copyright © 2020 Cedalo. All Rights Reserved<br>Original web theme developed by <a href="http://kamalchaneman.com/">Kamal Chaneman</a></p>
                </div>
            </div>
        </div>
    </footer><!-- footer -->
